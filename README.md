...
All documentation files (located in `/content/docs`) and all screenshots are licensed under **Creative Commons Attribution-NonCommercial-NoDerivatives 4.0 International (CC BY-NC-ND 4.0)**.

> In short: You may share the content, but you must credit this repo, may not use it for commercial purposes, and may not create derivative works (e.g., manipulating screenshots).

### Logo and Branding

Files located in the `/assets/branding` folder are **All Rights Reserved**.

_These files may not be copied, modified, or used in other projects without explicit written permission from the author. They are explicitly excluded from the open-source licenses above._
